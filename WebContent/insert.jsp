...
<div class="content">
  ...
  <%
    ...
    request.setCharacterEncoding("UTF-8"); //받아오는 값을 한글로 처리
     ...
     String board_writer = request.getParameter("board_writer");    // 넘어온 글제목 값 저장
     String board_type = request.getParameter("board_type");    // 넘어온 글제목 값 저장
     ...
     try{
       ...
       String sql = "insert into board(board_title, board_writer, board_type, board_content) values(?,?,?,?)"; // insert 쿼리문
